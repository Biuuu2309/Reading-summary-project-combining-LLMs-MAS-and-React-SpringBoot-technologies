...
public class messageservice {
    ...
    public message_user_ai getMessageById(String message_id) {
        return messagerepository.findById(message_id).orElseThrow(() -> new RuntimeException("Message not found"));
    }
